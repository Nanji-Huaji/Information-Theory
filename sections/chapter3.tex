...
\begin{example}
\label{ex:ch3-second-extension-model}
...
\begin{example}
\label{ex:ch3-binary-source-entropy}
...
\begin{example}
\label{ex:ch3-stationary-marginal}
...
\begin{example}
\label{ex:ch3-transition-matrix-check}
...
\begin{example}
\label{ex:ch3-one-two-step-transition}
