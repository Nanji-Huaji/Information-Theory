...
\begin{example}
\label{ex:ch6-erasure-channel-model}
...
\begin{example}
\label{ex:ch6-strongly-symmetric-check}
\textbf{判断强对称信道}：判断矩阵
\[
[P]=\begin{bmatrix}
0.3&0.2&0.5\\
...
\begin{example}
\label{ex:ch6-strongly-symmetric-capacity}
...
\begin{example}
\label{ex:ch6-cascaded-bsc-capacity}
