...
\begin{example}
\label{ex:ch2-ball-self-information}
...
\begin{example}
\label{ex:ch2-chessboard-information}
...
\begin{example}
\label{ex:ch2-binary-source-entropy}
...
\begin{example}
\label{ex:ch2-three-boxes-conditional-entropy}
...
\begin{example}
\label{ex:ch2-entropy-comparison}
...
\begin{example}
\label{ex:ch2-bsc-mutual-information}
...
\begin{example}
\label{ex:ch2-erasure-channel-mutual-information}
